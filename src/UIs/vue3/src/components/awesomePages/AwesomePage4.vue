    ...
    <div class="html">
        <div class="body">
            ...
            <div class="background">
                <div class="stars">
                    <div class="star" v-for="index in 60" :key="index"></div>
                </div>
                <div class="moon"></div>
                <div class="mountains">
                    <div class="mountain" v-for="index in 4" :key="index"></div>
                </div>
                <div class="sea">
                    <div class="wave" v-for="index in 30" :key="index"></div>
                    <div class="boat">
                        <div class="sail"></div>
                        <div class="sail"></div>
                        <div class="base"></div>
    ...
    .top {
        ...
        .middle {
            ...
            &:before {
                ...
                box-shadow: 0 0 10px $x-light, 0 0 20px $yellow,
                    0 0 30px $yellow, 0 0 40px $yellow, 0 0 70px $yellow;
            }
        }
        .roof {
            width: 0;
        ...
        .glow {
            ...
            box-shadow: 0 0 10px $yellow, 0 0 20px $yellow, 0 0 30px $yellow,
                ...
                0 0 70px $yellow, 0 0 80px $yellow;
