    ...
    <template #content>
      <div class="p-fluid">
        <div class="p-field p-grid">
          <label for="calendarName" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0"
            >Name</label
          >
          <div class="p-col-12 p-md-2">
            <InputText id="calendarName" type="text" v-model="calendar.name" />
          </div>
        </div>
        <div class="p-field p-grid">
          <label for="calendarCategory" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0"
            >Category</label
          >
          <div class="p-col-12 p-md-2">
            <Dropdown
        ...
        <div class="p-field p-grid">
          <label for="calendarColor" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0"
            >Color</label
          >
        ...
        <div class="p-field p-grid">
          <label for="calendarBgColor" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0"
            >Bg Color</label
          >
          <div class="p-col-12 p-md-1">
            <ColorPicker
        ...
        <div class="p-field p-grid">
          <label for="DragBgColor" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0"
            >Drag Bg Color</label
          >
          <div class="p-col-12 p-md-1">
            <ColorPicker
