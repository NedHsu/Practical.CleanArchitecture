...
import stockNewsReducer from "./containers/StockNews/reducer";
import { watchStockNew } from "./containers/StockNews/sagas";
...
sagaMiddleware.run(watchStockNew);
