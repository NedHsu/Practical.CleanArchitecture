...
class AddCalendar extends Component<Props, any> {
  state = {
    title: "Add Calendar",
    controls: {
      name: {
  ...
  componentDidMount() {
    ...
    if (id) {
      this.setState({ title: "Edit Calendar" });
  ...
  onSubmit = event => {
    ...
    for (let fieldName in this.state.controls) {
      isValid =
        this.checkFieldValidity(fieldName, this.props.calendar[fieldName]) &&
        isValid;
    }

    if (isValid) {
      this.props.saveCalendar(this.props.calendar);
    }
  };
  ...
  render() {
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-10">
                <input
                  ...
                  value={this.props.calendar?.name}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-10">
                <input
                  ...
                  value={this.props.calendar?.code}
                  onChange={event => this.fieldChanged(event)}
                />
                <span className="invalid-feedback">
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-10">
                <input
                  ...
                  value={this.props.calendar?.description}
                  onChange={event => this.fieldChanged(event)}
                />
                <span className="invalid-feedback">
    ...
    return this.state.submitted && this.props.saved ? (
      <Redirect to={"/calendars/" + this.props.calendar.id} />
    ) : (
      form
    );
  }
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    updateCalendar: calendar => dispatch(actions.updateCalendar(calendar)),
    resetCalendar: () => dispatch(actions.resetCalendar()),
    saveCalendar: calendar => dispatch(actions.saveCalendar(calendar))
  };
};
